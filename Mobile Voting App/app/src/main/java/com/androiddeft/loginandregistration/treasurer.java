...
public class treasurer extends AppCompatActivity {
    ...
    public void sendvote(View view){
        ...
        if (n == "Fragile") {
            ...
            databaseReference.child("Fragile").push().setValue(n);
        }
        else{
            databaseReference.child("Nifemi").push().setValue(n);
        }
        Intent startnew = new Intent(this, pro.class);
