...
public class gov extends AppCompatActivity {
    ...
    public void sendvote(View view){
        ...
        if (n == "Afriprint") {
            ...
            databaseReference.child("Afriprint").push().setValue(n);
        }
        else{
            databaseReference.child("Ganiyat").push().setValue(n);
        }
        Intent startnew = new Intent(this, gensec.class);
